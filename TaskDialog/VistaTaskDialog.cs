...
namespace PSTaskDialog
{
    ...
    internal delegate bool VistaTaskDialogCallback(VistaActiveTaskDialog taskDialog, VistaTaskDialogNotificationArgs args, object callbackData);

    /// <summary>
    /// The TaskDialog common button flags used to specify the builtin bottons to show in the TaskDialog.
    /// </summary>
    [Flags]
    internal enum VistaTaskDialogCommonButtons
    {
        /// <summary>
        /// No common buttons.
        /// </summary>
    ...
    /// </summary>
    internal enum VistaTaskDialogNotification
    {
        /// <summary>
    ...
    internal enum VistaProgressBarState
    {
        /// <summary>
        /// Normal.
        /// </summary>
    ...
    internal struct VistaTaskDialogButton
    {
        /// <summary>
    ...
    /// </summary>
    internal class VistaTaskDialog
    {
        /// <summary>
